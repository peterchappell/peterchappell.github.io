...
![Catcat public learning catalogue](./intellum/3.jpg)
...
Exceed is built as a traditional server-side rendered app using Ruby on Rails. It has a large and continually
growing set of features that need to be maintained at a high level of quality, maintainability and accessibility.
As such the front-end required continual upgrading, development and support. 
